...
const roadmapSteps = [
    {id: 1, title: "MODULO DE AGREGAÇÃO", status: "completed", position: "top", description: "TESTE"},
    {id: 2, title: "MODULO DE AGREGAÇÃO", status: "completed", position: "bottom", description: "teste"},
    {id: 3, title: "MODULO DE AGREGAÇÃO", status: "completed", position: "top", description: "teste"},
    {id: 4, title: "MODULO DE AGREGAÇÃO", status: "current", position: "bottom", description: "teste"},
    {id: 5, title: "MODULO DE AGREGAÇÃO", status: "up coming", position: "top", description: "teste"},
    {id: 6, title: "MODULO DE AGREGAÇÃO", status: "up coming", position: "bottom", description: "teste"},
];
                        ...
                        {roadmapSteps.map((step, index) =>(
                            <div key={step.id} className='relative flex flex-col items-center flex-1'
                                ...
                                <div className={`absolute w-[1px] h-16 bg-gradient-to-b ${step.position === 'top'
                                    ? 'bottom-1/2 from-transparent to white/40' : 'top-1/2 from-white/40 to-transparent'
                                }`}/>
                                ...
                                <div className='relative z-30 my-auto cursor-default'>
                                    <motion.div
                                        ...
                                        {step.status === 'current' && (<div className='w-2.5 h-2.5 bg-white rounded-full animate-pulse'/>)}
                                    ...
                                    {hoveredStep === step.id && (
                                        <motion.div
                                            ...
                                            ${step.position === 'top' ? 'top-10' : 'bottom-12'}`}>
                                                ...
                                                <p className='text-sm text-purple leading-relaxed whitespace-normal break-words'>{step.description}</p>
                                ...
                                <div className={`absolute whitespace-nowrap text-center ${step.position === 'top' ? 'bottom-28' : 'top-28'}`}>
                                        <h3 className={`text-xs md:text-sm font-black tracking-widest uppercase
                                            ${step.status === 'up coming' ? 'text-white/20' : 'text-white'}`}>
                                            {step.title}
                                        </h3>
                                </div>
                            </div>
